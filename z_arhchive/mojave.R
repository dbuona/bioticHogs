...
bos<-dplyr::filter(d.env,US_L3NAME== "Mojave Basin and Range")
...
lowinv.bos<-dplyr::filter(d.ref,RelCov_I<= 1)
...
###compare
jpeg("../git/bioticHogs/plots/mojave_14_beta.jpeg")
plot.decay(beta.decay.pristine, col="dark green",ylim=c(0.7,1), remove.dots=TRUE)
plot.decay(beta.decay.low, col="orange",ylim=c(0.7,1), remove.dots=TRUE,add=TRUE)
plot.decay(beta.decay.high, col="red",ylim=c(0.7,1), remove.dots=TRUE,add=TRUE)
plot.decay(beta.decay.invonly, col="black",lty = 2,ylim=c(0.7,1), remove.dots=TRUE,add=TRUE)
...
jpeg("../git/bioticHogs/plots/mojave_14_bal.jpeg")
...
jpeg("../git/bioticHogs/plots/Mojave_14_gra.jpeg")
plot.decay(gra.decay.pristine, col="dark green",ylim=c(0,.1), remove.dots=TRUE)
plot.decay(gra.decay.low, col="orange",ylim=c(0,.1), remove.dots=TRUE,add=TRUE)
plot.decay(gra.decay.high, col="red",ylim=c(0,.1), remove.dots=TRUE,add=TRUE)
plot.decay(gra.decay.invonly, col="black",lty=2,ylim=c(0,.1), remove.dots=TRUE,add=TRUE)
legend("topright", legend=c("pristine","low","full","introduced only"),title="Invasion Level",
       col=c("darkgreen","orange","red","black"), lty=c(1,1,1,2), cex=.8)
title("Mojave- gra. diversity")
dev.off()
...
jpeg("..//git/bioticHogs/plots/hillbeta_14_mojave.jpeg")
...
jpeg("..//git/bioticHogs/plots/hillmorsitahorn_14_mojave.jpeg")
