...
#d<-filter(d,Resampled=="N") ### non in this are resalmpled
...
lowinv.bos<-dplyr::filter(d.ref,RelCov_I<= 2)
...
d2.h<-dist(dater2.high,method="euclidean") ### distance matrix
...
###compare
jpeg("../git/bioticHogs/plots/NE_coast_59_beta.jpeg")
plot.decay(beta.decay.pristine, col="dark green",ylim=c(0.9,1), remove.dots=TRUE)
plot.decay(beta.decay.low, col="orange",ylim=c(0.9,1), remove.dots=TRUE,add=TRUE)
plot.decay(beta.decay.high, col="red",ylim=c(0.9,1), remove.dots=TRUE,add=TRUE)
plot.decay(beta.decay.invonly, col="black",lty = 2,ylim=c(0.9,1), remove.dots=TRUE,add=TRUE)
...
title("Northeastern Coastal Zone- Beta diversity")
dev.off()
...
jpeg("../git/bioticHogs/plots/NE_coast_59_bal.jpeg")
plot.decay(bal.decay.pristine, col="dark green",ylim=c(0.85,1), remove.dots=TRUE)
plot.decay(bal.decay.low, col="orange",ylim=c(0.85,1), remove.dots=TRUE,add=TRUE)
plot.decay(bal.decay.high, col="red",ylim=c(0.85,1), remove.dots=TRUE,add=TRUE)
plot.decay(bal.decay.invonly, col="black",lty = 2,ylim=c(0.85,1), remove.dots=TRUE,add=TRUE)
legend("bottomright", legend=c("pristine","low","full", "introduced only"),title="Invasion Level",
       col=c("darkgreen","orange","red","black"), lty=c(1,1,1,2), cex=.8)
title("Northeastern Coastal Zone- bal. diversity")
dev.off()
...
jpeg("../git/bioticHogs/plots/NE_coast_59_gra.jpeg")
plot.decay(gra.decay.pristine, col="dark green",ylim=c(0,.08), remove.dots=TRUE)
plot.decay(gra.decay.low, col="orange",ylim=c(0,.08), remove.dots=TRUE,add=TRUE)
plot.decay(gra.decay.high, col="red",ylim=c(0,.08), remove.dots=TRUE,add=TRUE)
plot.decay(gra.decay.invonly, col="black",lty=2,ylim=c(0,.08), remove.dots=TRUE,add=TRUE)
legend("topright", legend=c("pristine","low","full","introduced only"),title="Invasion Level",
       col=c("darkgreen","orange","red","black"), lty=c(1,1,1,2), cex=.95)
title("Northeastern Coastal Zone- gra. diversity")
dev.off()
...
jpeg("..//git/bioticHogs/plots/hillbeta_59_coastal.jpeg")
...
jpeg("..//git/bioticHogs/plots/hillmorsitahorm_59_coastal.jpeg")
