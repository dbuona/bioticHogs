...
bos<-dplyr::filter(d.env,US_L3NAME== "Northern Glaciated Plains")
...
###compare
jpeg("../git/bioticHogs/plots/northernglaciated_46_beta.jpeg")
...
title("Northern glaciated- Beta diversity")
dev.off()
...
jpeg("../git/bioticHogs/plots/northern_glaciated_46_bal.jpeg")
...
legend("bottomright", legend=c("pristine","low","full", "introduced only"),title="Invasion Level",
       col=c("darkgreen","orange","red","black"), lty=c(1,1,1,2), cex=.8)
title("Northern glaciated- bal. diversity")
dev.off()
...
legend("topright", legend=c("pristine","low","full","introduced only"),title="Invasion Level",
       col=c("darkgreen","orange","red","black"), lty=c(1,1,1,2), cex=.8)
title("Northern glaciated- gra. diversity")
dev.off()
...
jpeg("..//git/bioticHogs/plots/hillbeta_46_nglaciated.jpeg")
...
jpeg("..//git/bioticHogs/plots/hillmorsitahorn_46_nglaciated.jpeg")
